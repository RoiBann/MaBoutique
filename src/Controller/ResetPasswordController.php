    ...
    public function index(Request $request): Response
    {
        ...
        if($request->get('email'))
        {
            ...
            if ($user){
                ...
                $content = 'Bonjour ' .$user->getFirstname()."<br/>Vous avez demandé à réinitialiser votre mot de passe sur notre boutique.<br/><br/>";
                ...
                $this->addFlash('notice', "Vous allez recevoir dans quelques seconde un email avec la procédure de réinitialisation de mot de passe");
